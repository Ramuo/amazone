              ...
              {loading ? (
                ...
                <>
                  <Row className="justify-content-between mb-3">
                    <Col md={6}>
                      <div>
                        {countProducts === 0 ? 'NON' : countProducts} Resultats
                        {query !== 'all' && ' : ' + query}
                    ...
                    <Col className="text-end">
                      ...
                      >
                        <option value="newest">Les arrivages récents</option>
                  ...
                  {products.length === 0 && (
                    <MessageBox>Aucun produit ne correspond à votre recherche</MessageBox>
                  )}
